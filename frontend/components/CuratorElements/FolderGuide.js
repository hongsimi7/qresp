...
const TREE = [
  ...
  { depth: 2, name: "figure_S1/", kind: "folder" },
  { depth: 3, name: "figure_S1.png", kind: "image" },
  { depth: 3, name: "figure_S1.ipynb", kind: "file" },
  { depth: 3, name: "data/", kind: "folder" },
  { depth: 4, name: "...", kind: "file" },
  { depth: 2, name: "diagram/", kind: "folder" },
  { depth: 3, name: "diagram.png", kind: "image" },
...
const TIPS = [
  ...
  "Each immediate child of datasets/, scripts/ or tools/ is ONE Qresp record, and everything beneath that child belongs to it.",
  "A file placed directly under datasets/ is one dataset on its own.",
  "A Chart is ONE image, so a chart folder is judged image by image: name the figure after its folder (figure_S1/figure_S1.png) and Qresp proposes it without asking.",
  "preview.png and notebook.ipynb still work as the image and the notebook, and data/ holds a chart's inputs.",
  "A folder holding several images stays perfectly usable: Folder Analysis lists every one under its folder in Record boundaries, and you give each a role — Create Chart, Supporting File, or Ignore. Charts you create separately can be related afterwards in Workflow.",
