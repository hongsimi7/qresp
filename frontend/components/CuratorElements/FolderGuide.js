...
const TIPS = [
  ...
  "One independent chart per child folder gives the clearest result: name the image after its folder (figure_S1/figure_S1.png) and Qresp picks it without asking.",
  "preview.png and notebook.ipynb still work as the image and the notebook, and data/ holds a chart's inputs.",
  "A folder holding several images stays perfectly usable: Folder Analysis lists every one and you choose which is the primary image, which are related files, and which deserve a chart of their own.",
